...
Quick proof review; bookmarks

Heavy commercial tools; costs

Business Analyst

Fast form checks; data copy

Slow load times; no free option

Open‑Source Advocate

Extend engine; integrate CLI
...
Open & Render: Load standard PDFs (text, images) with thumbnails, bookmarks, page navigation.
...
Merge/split pages; rotate/reorder

v1.2

Form filling (AcroForms); export to PDF/A

v1.3

Digital signatures (verify & apply PAdES)
...
Document View: Toolbar with zoom, search, page controls.
...
Installer: Provide MSI or EXE with customizable options; integrate with Windows Installer service.
...
Adobe Acrobat DC Reference

Cold‑start load (10 pages)

≤ 2 s

~ 5 s (commercial average)
...
Continuous scroll throughput

≥ 50 pp/s

~ 25 pp/s

Cold launch startup time
